...
echo "Copying playbook file from git repo to master desired location"
cp /home/ubuntu/Terraform-with-ansible/Ansible/playbook.yml /home/ubuntu/ansible/playbook.yml
...
echo "Moving into the 'Terraform-scripts' directory..."
...
# Wait for 2 minutes before updating the Ansible inventory
